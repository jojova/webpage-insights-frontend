...
const AnalyseImagePage = () => {
  return (
    <div className="w-full bg-[#F0F0F0] p-4">
      ...
      {/* Chat Section */}
      <div>
        <h2 className="text-xl font-semibold mb-2">Analysis Image </h2>
        <p>This passage provides a brief biography of Steven Paul Jobs, 
          highlighting key aspects of his life and contributions to the technology industry. Born in 1955, 
          Jobs co-founded Apple Inc. alongside Steve Wozniak, playing a pivotal role 
          in the personal computer revolution of the 1970s and 1980s. </p>
          <br></br>
