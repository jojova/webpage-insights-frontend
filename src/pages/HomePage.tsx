...
const HomePage = () => {
  return (
    <div className="no-scrollbar flex h-screen w-screen flex-col items-center justify-between bg-gradient-to-t from-[#ADC8CD] to-[#FFFFFF]">
      {/* Title */}
      ...
      <div className="flex flex-col items-center justify-center gap-y-4 px-4">
        ...
        <div className="grid grid-cols-4 gap-x-2 lg:gap-x-4">
          <FeatureButton featureLabel="Chat" />
          <FeatureButton featureLabel="Analyse Image" />
          <FeatureButton featureLabel="CSV Analysis" />
          <FeatureButton featureLabel="Transcribe Video" />
        </div>
